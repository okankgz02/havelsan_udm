package com.havelsan.havelsan_udm.exception.exceptionörnek_2;
...
public class Yolcu {
    ...
    public void yurtdisiHarciKontrol() throws HarcException {
        ...
        if (this.harc < 15) {
            ...
            throw new HarcException();  //biz HarcException classını Exception clasından türettiğimiz için checked exception kabul edilir.Ve throw isle fırlamamız gerekir.
